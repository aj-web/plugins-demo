...
export const IconComponents = {
  ...
  Database: () =>
    h('svg', { class: 'w-4 h-4', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M12 2C7.589 2 4 3.79 4 6v12c0 2.21 3.589 4 8 4s8-1.79 8-4V6c0-2.21-3.589-4-8-4z' }),
      h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M4 10c0 2.21 3.589 4 8 4s8-1.79 8-4' })
    ]),
  Download: () =>
    h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
  ...
  // StatusIcon: unified status icon (props: { status, class })
  StatusIcon: (props = {}) => {
    const status = (props.status || '').toString();
    const cls = props.class || '';
    switch (status) {
      case 'ready':
        return h(IconComponents.CheckCircle2, { class: cls });
      case 'partial':
        return h(IconComponents.AlertCircle, { class: cls });
      case 'not_ready':
      default:
        // Use AlertCircle for not_ready and fallback
        return h(IconComponents.AlertCircle, { class: cls });
    }
  }
};
